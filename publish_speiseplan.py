...
def post_speiseplan_image_to_rocket_chat(speiseplan_png):
    ...
    res = rocket.chat_post_message(f'Woche startet am {now}. Auf den Plan klicken um Details zu sehen. (beep pop 🤖 this was posted by a [bot](https://github.com/skjerns/Speiseplan-To-Rocket-Chat))',
                         channel='Speiseplan',
